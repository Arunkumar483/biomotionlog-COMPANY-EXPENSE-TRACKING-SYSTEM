...
<html>
<head>
	<title>BiOMotionLog Query/Chat Room</title>
	<link href='http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,400,300' rel='stylesheet' type='text/css'>
	<link rel="stylesheet" href="chat/css1/style.css" /><meta charset="UTF-8" name="viewport" content="width=device-width, initial-scale=1.0">
...
body{
  background:#b2d4d9;
	...
	<script type="text/javascript" src="chat/js1/jquery-1.10.2.min.js" ></script>
</head>
<body>
<div class='header'>
	<h1>
		BIOMOTIONLOG  CHAT ROOM
		<a href="adminlogin.php" class="btn btn-block ">Go back to Dashboard(Admin)</a>
		<a href="index.php" class="btn btn-block ">Go back to Dashboard(User)</a>
	</h1>
...
<div class='chatcontrols'>
	...
	<input type='text' name='chat' id='chatbox' autocomplete="off" placeholder="KINDLY MENTION TO WHOM U ARE ADDRESSING" value="TO ADMIN" />
